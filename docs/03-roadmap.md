...
| 3 | Use `sendrecv_v2` with zstd for `pull` and `push` ([#1](https://github.com/promethea156/adbcpp/issues/1); lz4 [#35](https://github.com/promethea156/adbcpp/issues/35) and brotli [#34](https://github.com/promethea156/adbcpp/issues/34) follow) | P6. A transfer is never compressed today. |
...
- **Use `sendrecv_v2` with zstd for `pull` and `push`.** The v1 `RECV`/`SEND` forms are sent today, so a transfer is never compressed. [Slice 9](#slice-9--release-10) removed the false `sendrecv_v2` claim from the banner; implementing the v2 forms with zstd would let a transfer compress, and lz4 ([#35](https://github.com/promethea156/adbcpp/issues/35)) and brotli ([#34](https://github.com/promethea156/adbcpp/issues/34)) would follow. ([issue #1](https://github.com/promethea156/adbcpp/issues/1))
